            ...
            else if(MQTT_RxDataOutPtr[2] == 0x90)
            {
                ...
                case 0x01 :
                    u1_printf("订阅成功\r\n");             //串口输出信息
										OLED_Clear();
										OLED_Update();
											OLED_ShowChinese(0,16,"连");
											OLED_ShowChinese(16,16,"接");
											OLED_ShowChinese(32,16,"成");
											OLED_ShowChinese(48,16,"功");
											OLED_Update();
											delay_ms(3000);
										OLED_Clear();
										OLED_Update();
...
//										OLED_Update();
    ...
    {
        u1_printf("准备连接服务器\r\n");                  //串口输出信息
					OLED_ShowChinese(0,16,"准");
					OLED_ShowChinese(16,16,"备");
					OLED_ShowChinese(32,16,"连");
					OLED_ShowChinese(48,16,"接");
